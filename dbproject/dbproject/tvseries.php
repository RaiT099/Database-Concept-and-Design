...
<body>
	...
	<input type="checkbox" id="sidebar-toggle">
	 ...
	 <div class="main-content">
	 	...
	 	<header><h2 class="dash-title">TV Series Data</h2></header>
	 			...
	 			<section class="recent">
	 				<div class="activity-grid">
		 				<div class="activity-card">
		 					<h3>TV Series</h3>
		 					<div>
		 						<a href="edit.php" class="position">
		 								 ...
		 								 if($result->num_rows > 0) {
			 								 while($row = $result->fetch_assoc())
			 								 {
			 									...
			 									<tr>
			 										...
			 										<td>
			 											<a href="edit.php?edit1=<?php echo$row ['TV_ID'];?>">
			 											<button class="badge btn-info">Edit</button></a>
			 											<a href="process.php?delete=<?php echo $row ['TV_ID'];?>">
